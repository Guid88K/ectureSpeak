        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 my-5 ">
                <form action="{{ route('post.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="cart_new p-3 blok_two py-5">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <h2 class="text-primary">Завантажити нову публікацію</h2>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="row my-3 ">
                                    <div class="col-md-4 col-sm-12"><span class="text-primary">Силка на відео:</span>
                                    </div>
                                    <div class="col-md-8 col-sm-12">
                                        <input type="text" class="form-control rounded-pill border border-primary"
                                            id="exampleInputEmail1" name="url_for_file" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                ...
                                <div class="row my-3 mb-5">
                                    <div class="col-md-4 col-sm-12"><span class="text-primary">Текст:</span>
                                    </div>
                                    <div class="col-md-8 col-sm-12">
                                        <textarea class="form-control rounded border border-primary"
                                            id="exampleFormControlTextarea1" name="content_post" placeholder="Add coment ..."
                                            rows="3"></textarea>
                                    </div>
                                </div>
