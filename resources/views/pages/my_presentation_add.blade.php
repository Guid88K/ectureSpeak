    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 my-5">
                <form action="{{ route('my_presentation.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 mb-3">
                                <div class="d-flex justify-content-center">
                                    ...
                                    <h2 class="text-primary">Завантажити нову презентацію</h2>
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="row my-3 ">
                                    <div class="col-md-4 col-sm-12"><span class="text-primary">Презентація:</span>
                                    </div>
                                    <div class="col-md-8 col-sm-12">
                                        <input class="form-control rounded-pill border border-primary" type="file"
                                            id="formFile" name="file" accept="">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        ...
                                        <select class="form-select form-control rounded-pill border border-primary"
                                            aria-label="Default select example" name="category_post">
                                            <option selected>Виберіть ваш предмет</option>
                                            <option value="1">Історія</option>
                                            <option value="2">Хімія</option>
                                            <option value="3">Математика</option>
                                            <option value="4">Географія </option>
                                            <option value="5">Фізика</option>
                                            <option value="6">Біологія</option>
                                            <option value="7">Мистецтво</option>
                                        </select>
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <input type="text" class="form-control rounded-pill border border-primary"
                                            id="exampleInputEmail1" name="autor" aria-describedby="emailHelp">
                                    </div>
                                </div>
