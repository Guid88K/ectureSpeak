                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="border border-primary rounded-pill px-3">
                            <form action="{{route('search_by_name_presantation')}}" class="d-flex border-0 ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12">
                            ...
                            <div class="d-flex justify-content-around">
                                ...
                                <div class="card_predmet text-center">
                                    <a href="{{route('category_search_presantation','Географія')}}">
                            ...
                            <div class="cart_book">
                                <div class="d-flex justify-content-center">
                                    <a href="{{ 'uploads/' . $p->file }}">
                                        <img src="{{ asset('uploads/' . $p->preview) }}" width="100%" height="100%" alt=""></a>
                                </div>
