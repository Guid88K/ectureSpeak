        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="border border-primary rounded-pill px-3">
                            <form action="{{route('search_by_name_book')}}" class="d-flex border-0 ">
                                <input class="form-control border-0 " type="search" name="name" placeholder="Пошук" aria-label="Search">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 col-sm-12">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <div class="card_predmet text-center">
                                <a href="{{route('category_search_book','Географія')}}">
            ...
            <div class="col-md-12 col-sm-12 mt-md-3 mt-md-0">
                <div class="row justify-content-start">
                    @foreach ($posts as $p)
                        <div class=" col-md-3 col-sm-12  mt-md-3 mt-sm-0 ">
                            <div class="cart_book">
                                <div class="d-flex justify-content-center">
                                    <a href="{{ 'uploads/' . $p->file }}">
                                        <img src="{{ asset('uploads/' . $p->preview) }}" alt="" width="200px" height="300px">
                                    </a>
                                </div>
